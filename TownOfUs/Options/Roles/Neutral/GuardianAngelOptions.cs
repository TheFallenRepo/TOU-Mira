...
public sealed class GuardianAngelOptions : AbstractOptionGroup<GuardianAngelTouRole>
{
    ...
    [ModdedEnumOption("Show Protected Player", typeof(ProtectOptions), ["Target", "Guardian Angel", "Target + GA"])]
    ...
    public BecomeOptions OnTargetDeath { get; set; } = BecomeOptions.Survivor;
