...
public sealed class HunterOptions : AbstractOptionGroup<HunterRole>
{
    ...
    [ModdedNumberOption("Hunter Stalk Cooldown", 1f, 15f, 1f, MiraNumberSuffixes.Seconds)]
    public float HunterStalkCooldown { get; set; } = 10f;

    [ModdedNumberOption("Hunter Stalk Duration", 10f, 60f, 2.5f, MiraNumberSuffixes.Seconds)]
    ...
    public bool HunterBodyReport { get; set; } = true;
}